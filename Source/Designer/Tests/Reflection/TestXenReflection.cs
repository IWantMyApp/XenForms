...
{
    [TestFixture]
    public class TestXenReflection
    {
        ...
        [Test]
        public void Test_GetXenRefProperties()
        {
            var label = new Label();
            var refProps = label.GetXenRefProperties();
            CollectionAssert.IsNotEmpty(refProps);
        }


        [Test]
        public void Test_GetXenRefProperties_with_simple_Path()
        {
            ...
            var props = page.GetXenRefProperties(new[] { "Content", "Content", "Content"});
        ...
        [Test]
        public void Test_GetXenRefProperties_with_single_path()
        {
            var label = new Label();
            var props = label.GetXenRefProperties(new[] {"HorizontalOptions"});
        ...
        [Test]
        public void Test_GetXenRefProperties_with_null_path()
        {
            var page = new ContentPage();
            Assert.Throws<InvalidOperationException>(() => page.GetXenRefProperties(null));
        }


        [Test]
        public void Test_GetXenRefProperties_with_indexer()
        {
            var grid = new Grid();
            ...
            // row 1 assert
            var row1HeightProps = page.GetXenRefProperties(new[] {"Content", "RowDefinitions[0]", "Height"});
            ...
            // row 2 assert
            var row2HeightProps = page.GetXenRefProperties(new[] { "Content", "RowDefinitions[1]", "Height" });
